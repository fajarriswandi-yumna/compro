            ...
            <div class="col-md-8">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0"><i class="fas fa-plus"></i> &nbsp;Create</h6>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary text-white btn-block">Save Post</button>
                            <a href="{{ route('admin.posts.index') }}" class="btn btn btn-outline-secondary">Cancel</a>
                        </div>
